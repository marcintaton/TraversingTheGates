...
void TextureManager::load_game_textures()
{
    ...
    textures[TextureType::WALL] = load_texture("assets/textures/ground.png");
    textures[TextureType::PLAYER] = load_texture("assets/textures/ground.png");
    textures[TextureType::H_DOOR_CLOSED] =
        load_texture("assets/textures/ground.png");
